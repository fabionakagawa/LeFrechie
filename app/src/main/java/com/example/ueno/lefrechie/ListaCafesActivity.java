...
public class ListaCafesActivity extends Activity {
    ProdutoDAO dao;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        registros = dao.listarTodosDoces("Cafe");

        if(registros.size() == 0){
            Intent i = new Intent(getApplicationContext(), ProdutoActivity.class);
            startActivity(i);
            Toast.makeText(getApplicationContext(), "Ainda não há cadastro de cafés.",
            ...
            listAdapter = (ListViewCustomAdapter) new ListViewCustomAdapter(this, R.layout.single_item_cafe, registros);
