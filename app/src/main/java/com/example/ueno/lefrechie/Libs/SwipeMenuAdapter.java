...
import com.example.ueno.lefrechie.Libs.SwipeMenuView.OnSwipeItemClickListener;
...
public class SwipeMenuAdapter implements WrapperListAdapter,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            menuView.setOnSwipeItemClickListener((SwipeMenuView.OnSwipeItemClickListener) this);
